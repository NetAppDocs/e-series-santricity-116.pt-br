...
* Quando pelo menos uma área de capacidade livre é detetada para um grupo de volumes, a recomendação *consolidar capacidade livre* aparece na página inicial na área de notificação. Clique no link *Consoildate Free Capacity* para iniciar a caixa de diálogo.
* Você também pode iniciar a caixa de diálogo capacidade livre de Consoildate na página pools e grupos de volume, conforme descrito na tarefa a seguir.
