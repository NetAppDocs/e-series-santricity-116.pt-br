...
====
+
Se a unidade estiver habilitada para *não* com segurança, a caixa de diálogo *Confirm Assign Hot Spare Drive* (confirmar atribuição de unidade hot Spare*) será aberta.
