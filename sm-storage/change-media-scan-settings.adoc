...
+
A caixa de diálogo *alterar as configurações de digitalização de Mídia da unidade* é exibida. Todos os volumes na matriz de armazenamento aparecem nesta caixa de diálogo.
